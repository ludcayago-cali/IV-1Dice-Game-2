...
function createLobbyModal() {
  ...
  document.getElementById("createGameBtn").addEventListener("click", () => {
    ...
    note.textContent = `Game created. Password: ${code}. Share it with your guest. Real online sync is not active in this static build.`;
  });
  ...
  document.getElementById("joinGameBtn").addEventListener("click", () => {
    ...
    const note = document.getElementById("lobbyNote");
    if (!code) {
      note.textContent = "Enter a password first.";
      return;
    }
